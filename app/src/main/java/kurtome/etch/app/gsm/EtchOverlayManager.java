...
//    }
    ...
    public void addEtch(LatLngBounds latLngBounds, final int etchGridRow) {
        EtchOverlayImage etchOverlayImage = new EtchOverlayImage(mGoogleMapFragment, latLngBounds);
...
//                }
//
//                mCanvas.drawBitmapScalingBasedOnHeightThenCropping(bitmap, xOffset, yOffset, DrawingBrush.BASIC_PAINT);
